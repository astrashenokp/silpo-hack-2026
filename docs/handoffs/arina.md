...
* **Handoff (`docs/handoffs/arina.md`)**: Написано детальну інструкцію для Ріни та Уляни щодо того, як імпортувати та викликати функції без необхідності парсити сирий MCP-формат[cite: 8].
