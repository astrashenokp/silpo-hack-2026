...
|---|---|---|
| The UI never calls the API, so no Silpo MCP call is visible in the product | The MCP must be functionally significant, and "MCP quality" is a judging criterion | BUG-002; live MCP verification by Arina/Rina |
