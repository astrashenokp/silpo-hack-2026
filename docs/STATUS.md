...
| Polina | In progress: early intake; September 11 | [QA results](qa/test-results.md), [bugs](qa/bugs.md), [handoff draft](handoffs/polina.md); branch `feature/polina-integration-qa` | Final integration 12th; deploy, QA and demo freeze 13th | Clean setup blocked by BUG-001 (Rina/Uliana); UI not using the API, BUG-002 (Ksiusha/Alina); recalculation BUG-003 (Uliana). E2E suite, CI and deployment draft continue meanwhile |
